    ...
    <div class="container-fluid remove-vid-marg">
      <div class="vid-parent">
        <video playsinline autoplay muted loop>
          <source src="video/cutm.mp4" />
        </video>
        <div class="vid-overlay"></div>
      </div>
      <div class="vid-content" >
        <h1 class="my-content">Welcome to Nexus</h1>
        <small class="my-content">Invest in Yourself</small><br />
        <?php    
    ...
    <div class="container-fluid p-4" style="background-color:#E9ECEF">
      <div class="container" style="background-color:#E9ECEF">
        <div class="row text-center">
          <div class="col-sm">
            <h5>About Us</h5>
              <p>Nexus provides universal access to the world’s best education, partnering with top universities and organizations to offer courses online.</p>
          </div>
          <div class="col-sm">
            <h5>Category</h5>
            <a class="text-dark" href="#">Web Development</a><br />
            <a class="text-dark" href="#">Android App Development</a><br />
            <a class="text-dark" href="#">IoT</a><br />
            <a class="text-dark" href="#">Full Stack Java Development</a><br />
            <a class="text-dark" href="#">DBMS</a><br />
          </div>
          <div class="col-sm">
            <h5>Contact Us</h5>
            <p>Nexus Pvt Ltd <br> Rushikonda <br> Vishakapatnam, Andhra Pradesh <br> Ph. 7995621613 </p>
          </div>
        </div>
      </div>  
